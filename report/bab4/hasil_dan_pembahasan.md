...
![Gambar 4.3: Active Learning Queue di Streamlit](images/gambar_4_3_active_learning_queue.png)

**Gambar 4.3: Tampilan Active Learning Queue di Streamlit UI**
...
![Gambar 4.4: Model Registry di Streamlit](images/gambar_4_5_model_registry.png)

**Gambar 4.4: Tampilan Model Registry di Streamlit UI**
...
![Gambar 4.5: Monitoring Dashboard di Streamlit](images/gambar_4_4_monitoring_dashboard.png)

**Gambar 4.5: Tampilan Monitoring Dashboard di Streamlit UI**
...
![Gambar 4.6: Status Deployment](images/gambar_4_6_deployment_status.png)

**Gambar 4.6: Status deployment pada DigitalOcean Droplet**

Sumber: Screenshot dari docker-compose ps
